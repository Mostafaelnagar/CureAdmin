package app.grand.ophthalmicadmin.doctor.profile;
...
import app.grand.ophthalmicadmin.databinding.FragmentUpdateProfileDoctorBinding;
import app.grand.ophthalmicadmin.doctor.profile.viewModels.ProfileViewModels;


public class DoctorUpdateAuthFragment extends BaseFragment {
    FragmentUpdateProfileDoctorBinding updateProfileBinding;
    ProfileViewModels profileViewModels;
    Resources resources;
    private String passingObject;
    private Bundle bundle;

    public DoctorUpdateAuthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        updateProfileBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_update_profile_doctor, container, false);
            ...
            public void onChanged(Boolean isConnected) {
                if (isConnected) {
                    if (bundle != null) {
                        ...
                        if (profileViewModels.getPassingObject().getCode() == Codes.UPDATE_AUTH) {
                            profileViewModels.getExtraData();
                        }
                    }
