...
//        Params.status = notification.get("type");
//        Params.shop_id = notification.get("shop_id");
//        Params.order_id = notification.get("order_id");
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentText(notification.get("message"))
                        .setAutoCancel(true)
